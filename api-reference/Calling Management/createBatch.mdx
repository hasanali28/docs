...
If omitted, the API automatically creates a voice batch.
</ParamField>
...
<ParamField body="holidayListId" type="string">
Optional holiday list ID to associate with the batch. Calls scheduled on the holidays defined in the specified holiday list will be skipped during campaign execution.
</ParamField>
...
curl --location '{{baseUrl}}/api/call/createBatch' \
  ...
  --data '{
    ...
    "callingNumbers": ["12e5f12345abcdef87654321"],
    "retry": 3,
    "delay": 60,
    "timezone": "America/New_York",
    "callingHour": {"start": "09:00", "end": "17:00"},
    "allowedDays": [Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday],
    "holidayListId": "12f12345abcdef9876543210"
  }'
```
